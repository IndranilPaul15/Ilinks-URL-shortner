...
export default function SignIn() {
    ...
    const { settoggle, setOpenA } = useOpen()
    ...
    return (
        <div className="flex items-center justify-center pr-3 rounded-xl">

            <div className="w-full relative max-w-md shadow-2xl rounded-xl md:mt-10 p-6 space-y-3">
                <Bgauth />
                <button onClick={() => { setOpenA(false); settoggle("signup") }} className="absolute  right-3 top-4 active:scale-110 "><X color="white" size={30} /></button>
                <div className="space-y-3 mt-12 md:px-5">
                    <div className=" relative flex justify-center items-center">
                        <h1 className="text-3xl bg-clip-text text-transparent drop-shadow-[0_0_4px_black] font-semibold text-center text-white baloo">Welcome Back! Sign In</h1>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        />
                        <div className="relative w-[83vw] md:w-[25vw] flex">
                            <input
                        ...
                        <button onClick={() => {
                            setTimeout(() => { setOpenA(false), setLoading(false) }, 3000);
                        }} type="submit" className="w-full bg-blue-500 hover:bg-blue-600 text-white py-2 rounded-lg transition duration-300">
                    ...
                    <div className=" flex justify-center pt-2">
                        ...
                        <button onClick={() => settoggle("signup")} className="text-blue-500 mx-2 hover:font-bold active:scale-95"> Sign Up Now!</button>
                    </div>
                </div>
            </div>
        </div>
